...
var _TileTypes = __webpack_require__(14);
  ...
  sock.onmessage = function onmessage(event) {
    ...
    switch (message.type) {
      ...
      case _MessageTypes2.default.Port:
        ...
        if (message.success === true) {
          ...
          playerCharacter = sprites.find(function (s) {
            return s.instanceId === client.instanceId;
          }); // SPRITE
      ...
      case _MessageTypes2.default.Spawn:
        ...
        var newSpawn = Object.assign(new spawnClass(), message.spawn);
...
var drawSprites = function drawSprites() {
  ...
  sprites.forEach(function (sprite) {
    ...
    if (sprite instanceof _FireBall2.default) {
      drawSprite(sprite.position.x, sprite.position.y, SpriteTextureMap.get(_SpriteTypes.SpriteTypes.FIREBALL), sprite.angle);
...
function keyPressed(keyName) {
  ...
  if (keyName.toUpperCase().indexOf('UNMAPPED') === 0) {
    ...
    sendPackage(_MessageTypes2.default.KeyPressed, { action: keyName });
  }
}
...
{ code: 16, action: _PlayerActions2.default.SHIFT }];
...
function mouseClick(e) {
  sendPackage(_MessageTypes2.default.KeyPressed, {
    action: _PlayerActions2.default.MOUSE_ACTION_1,
